...
ALTER TABLE SEFAZ_ARR.TA_PEDIDO_TIPO_ACOES ADD CONSTRAINT CK_PEDIDO_TIPO_ACOES2 CHECK (TIPO_ACAO between 1 and 4);
...
ALTER TABLE SEFAZ_ARR.TA_PEDIDO_CAMPOS_ACOES ADD CONSTRAINT CK_PEDIDO_CAMPOS_ACOES2 CHECK (ID_CAMPO_PEDIDO between 1 and 8); 
...
CREATE TABLE SEFAZ_ARR.TA_PLANO_CONTAS (
  ...
  CONTA_HIERARQUICA   varchar2(20) CONSTRAINT NN_PLANO_CONTAS4 NOT NULL, 
...
ALTER TABLE TA_PAGOS_CORRIGIDOS ADD CONSTRAINT "FK_PAGOS_CORRIGIDOS1" FOREIGN KEY (ID_PEDIDO) REFERENCES TA_PEDIDO_SOLICITACAO (ID_PEDIDO);
ALTER TABLE TA_ARQUIVO_RECEPCAO ADD CONSTRAINT "FK_ARQUIVO_RECEPCAO1" FOREIGN KEY (ID_BANCO) REFERENCES TA_BANCOS (ID_BANCO);
ALTER TABLE TA_PEDIDO_CAMPOS_INFORMADOS ADD CONSTRAINT "FK_PEDIDO_CAMPOS_INFORMADOS1" FOREIGN KEY (ID_CAMPO_PEDIDO) REFERENCES TA_PEDIDO_CAMPOS_ACOES (ID_CAMPO_PEDIDO);
ALTER TABLE TA_ARQUIVO_RECEPCAO ADD CONSTRAINT "FK_ARQUIVO_RECEPCAO2" FOREIGN KEY (ID_CONVENIO) REFERENCES TA_CONVENIOS_ARREC (ID_CONVENIO);
ALTER TABLE TA_PEDIDO_RECEITA ADD CONSTRAINT "FK_PEDIDO_RECEITA1" FOREIGN KEY (ID_TIPO_PEDIDO) REFERENCES TA_PEDIDO_TIPOS (ID_TIPO_PEDIDO);
ALTER TABLE TA_PAGOS_ARREC ADD CONSTRAINT "FK_PAGOS_ARREC1" FOREIGN KEY (ID_BDAR_TPAR) REFERENCES TA_LOTES_PAGOS_ARREC (ID_BDAR_TPAR);
ALTER TABLE TA_LOTES_PAGOS_ARREC ADD CONSTRAINT "FK_LOTES_PAGOS_ARREC1" FOREIGN KEY (ID_BANCO) REFERENCES TA_BANCOS (ID_BANCO);
ALTER TABLE TA_LOTES_PAGOS_ARREC ADD CONSTRAINT "FK_LOTES_PAGOS_ARREC2" FOREIGN KEY (ID_BANCO, ID_AGENCIA) REFERENCES TA_BANCO_AGENCIAS (ID_BANCO, ID_AGENCIA);
ALTER TABLE TA_PEDIDO_DETALHE_PARECER ADD CONSTRAINT "FK_PEDIDO_DETALHE_PARECER1" FOREIGN KEY (ID_PEDIDO) REFERENCES TA_PEDIDO_SOLICITACAO (ID_PEDIDO);
ALTER TABLE TA_ARQUIVO_ERRO ADD CONSTRAINT "FK_ARQUIVO_ERRO1" FOREIGN KEY (ID_DETALHE_ARQUIVO) REFERENCES TA_ARQUIVO_DETALHE_PAGOS (ID_DETALHE_ARQUIVO);
ALTER TABLE TA_DELEGACIA_AGENCIAS ADD CONSTRAINT "FK_DELEGACIA_AGENCIAS1" FOREIGN KEY (ID_DELEGACIA) REFERENCES TA_DELEGACIAS (ID_DELEGACIA);
ALTER TABLE TA_PAGOS_RESTITUICAO ADD CONSTRAINT "FK_PAGOS_RESTITUICAO1" FOREIGN KEY (ID_PEDIDO) REFERENCES TA_PEDIDO_SOLICITACAO (ID_PEDIDO);
ALTER TABLE TA_PLANO_CONTAS ADD CONSTRAINT "FK_PLANO_CONTAS1" FOREIGN KEY (ID_GRUPO_CNAE) REFERENCES TA_TIPO_GRUPOS_CNAES (ID_GRUPO_CNAE);
ALTER TABLE TA_PEDIDO_SOLICITACAO ADD CONSTRAINT "FK_PEDIDO_SOLICITACAO1" FOREIGN KEY (ID_TIPO_PEDIDO) REFERENCES TA_PEDIDO_TIPOS (ID_TIPO_PEDIDO);
ALTER TABLE TA_PEDIDO_AREAS ADD CONSTRAINT "FK_PEDIDO_AREAS1" FOREIGN KEY (ID_UNIDADE_DELEGACIA, ID_DELEGACIA) REFERENCES TA_DELEGACIA_AGENCIAS (ID_UNIDADE_DELEGACIA, ID_DELEGACIA);
ALTER TABLE TA_PAGOS_ARREC ADD CONSTRAINT "FK_PAGOS_ARREC2" FOREIGN KEY (ID_DETALHE_ARQUIVO) REFERENCES TA_ARQUIVO_DETALHE_PAGOS (ID_DETALHE_ARQUIVO);
ALTER TABLE TA_PEDIDO_DOCS ADD CONSTRAINT "FK_PEDIDO_DOCS1" FOREIGN KEY (ID_PEDIDO) REFERENCES TA_PEDIDO_SOLICITACAO (ID_PEDIDO);
ALTER TABLE TA_CONVENIOS_TARIFAS ADD CONSTRAINT "FK_CONVENIOS_TARIFAS1" FOREIGN KEY (ID_CONVENIO) REFERENCES TA_CONVENIOS_ARREC (ID_CONVENIO);
ALTER TABLE TA_DELEGACIA_RECEITAS ADD CONSTRAINT "FK_DELEGACIA_RECEITAS1" FOREIGN KEY (ID_RECEITA) REFERENCES TA_RECEITAS (ID_RECEITA);
ALTER TABLE TA_MUNICIPIOS_CONTAS ADD CONSTRAINT "FK_MUNICIPIOS_CONTAS2" FOREIGN KEY (ID_BANCO, ID_AGENCIA) REFERENCES TA_BANCO_AGENCIAS (ID_BANCO, ID_AGENCIA);
ALTER TABLE TA_PAGOS_ARREC ADD CONSTRAINT "FK_PAGOS_ARREC3" FOREIGN KEY (ID_REPASSE) REFERENCES TA_RTC_REPASSE (ID_REPASSE);
ALTER TABLE TA_RECEITAS_TAXAS ADD CONSTRAINT "FK_RECEITAS_TAXAS1" FOREIGN KEY (ID_RECEITA) REFERENCES TA_RECEITAS (ID_RECEITA);
ALTER TABLE TA_PAGOS_ARREC ADD CONSTRAINT "FK_PAGOS_ARREC4" FOREIGN KEY (ID_RECEITA) REFERENCES TA_RECEITAS (ID_RECEITA);
ALTER TABLE TA_DELEGACIA_RECEITAS ADD CONSTRAINT "FK_DELEGACIA_RECEITAS2" FOREIGN KEY (ID_DELEGACIA) REFERENCES TA_DELEGACIAS (ID_DELEGACIA);
ALTER TABLE TA_PAGOS_CORRIGIDOS ADD CONSTRAINT "FK_PAGOS_CORRIGIDOS2" FOREIGN KEY (ID_BDAR_TPAR, ORDEM_LOTE) REFERENCES TA_PAGOS_ARREC (ID_BDAR_TPAR, ORDEM_LOTE);
ALTER TABLE TA_PEDIDO_SOLICITACAO ADD CONSTRAINT "FK_PEDIDO_SOLICITACAO2" FOREIGN KEY (ID_ACOES) REFERENCES TA_PEDIDO_TIPO_ACOES (ID_ACOES);
ALTER TABLE TA_PAGOS_RESTITUICAO ADD CONSTRAINT "FK_PAGOS_RESTITUICAO2" FOREIGN KEY (ID_BDAR_TPAR, ORDEM_LOTE) REFERENCES TA_PAGOS_ARREC (ID_BDAR_TPAR, ORDEM_LOTE);
ALTER TABLE TA_ARQUIVO_DETALHE_PAGOS ADD CONSTRAINT "FK_ARQUIVO_DETALHE_PAGOS1" FOREIGN KEY (ID_ARQUIVOS) REFERENCES TA_ARQUIVO_RECEPCAO (ID_ARQUIVOS);
ALTER TABLE TA_PEDIDO_DOCS ADD CONSTRAINT "FK_PEDIDO_DOCS2" FOREIGN KEY (ID_TIPO_DOCS) REFERENCES TA_PEDIDO_TIPO_DOCS (ID_TIPO_DOCS);
ALTER TABLE TA_RESUMO_ARRECADACAO ADD CONSTRAINT "FK_RESUMO_ARRECADACAO1" FOREIGN KEY (ID_ARRECADACAO) REFERENCES TA_ESTATISTICAS_ARRECADACAO (ID_ARRECADACAO);
ALTER TABLE TA_PEDIDO_TIPO_ACOES ADD CONSTRAINT "FK_PEDIDO_TIPO_ACOES1" FOREIGN KEY (ID_TIPO_PEDIDO) REFERENCES TA_PEDIDO_TIPOS (ID_TIPO_PEDIDO);
ALTER TABLE TA_PEDIDO_CONTA_TRIBUTARIA ADD CONSTRAINT "FK_PEDIDO_CONTA_TRIBUTARIA1" FOREIGN KEY (ID_PEDIDO) REFERENCES TA_PEDIDO_SOLICITACAO (ID_PEDIDO);
ALTER TABLE TA_PEDIDO_AREAS_SERVIDORES ADD CONSTRAINT "FK_PEDIDO_AREAS_SERVIDORES1" FOREIGN KEY (ID_PEDIDO_AREA) REFERENCES TA_PEDIDO_AREAS (ID_PEDIDO_AREA);
ALTER TABLE TA_PEDIDO_PAGOS ADD CONSTRAINT "FK_PEDIDO_PAGOS1" FOREIGN KEY (ID_BDAR_TPAR, ORDEM_LOTE) REFERENCES TA_PAGOS_ARREC (ID_BDAR_TPAR, ORDEM_LOTE);
ALTER TABLE TA_PEDIDO_RESTITUICAO ADD CONSTRAINT "FK_PEDIDO_RESTITUICAO1" FOREIGN KEY (ID_PEDIDO) REFERENCES TA_PEDIDO_SOLICITACAO (ID_PEDIDO);
ALTER TABLE TA_DELEGACIA_ENDERECO ADD CONSTRAINT "FK_DELEGACIA_ENDERECO1" FOREIGN KEY (ID_DELEGACIA) REFERENCES TA_DELEGACIAS (ID_DELEGACIA);
ALTER TABLE TA_RTC_FINANCEIRO ADD CONSTRAINT "FK_RTC_FINANCEIRO1" FOREIGN KEY (ID_REPASSE) REFERENCES TA_RTC_REPASSE (ID_REPASSE);
ALTER TABLE TA_PEDIDO_PAGOS ADD CONSTRAINT "FK_PEDIDO_PAGOS2" FOREIGN KEY (ID_PEDIDO) REFERENCES TA_PEDIDO_SOLICITACAO (ID_PEDIDO);
ALTER TABLE TA_GRUPOS_CNAE ADD CONSTRAINT "FK_GRUPOS_CNAE1" FOREIGN KEY (ID_GRUPO_CNAE) REFERENCES TA_TIPO_GRUPOS_CNAES (ID_GRUPO_CNAE);
ALTER TABLE TA_BANCO_AGENCIAS ADD CONSTRAINT "FK_BANCO_AGENCIAS1" FOREIGN KEY (ID_BANCO) REFERENCES TA_BANCOS (ID_BANCO);
ALTER TABLE TA_PEDIDO_CAMPOS_ACOES ADD CONSTRAINT "FK_PEDIDO_CAMPOS_ACOES1" FOREIGN KEY (ID_ACOES) REFERENCES TA_PEDIDO_TIPO_ACOES (ID_ACOES);
ALTER TABLE TA_PEDIDO_DETALHE_PARECER ADD CONSTRAINT "FK_PEDIDO_DETALHE_PARECER2" FOREIGN KEY (ID_PEDIDO_AREA) REFERENCES TA_PEDIDO_AREAS (ID_PEDIDO_AREA);
ALTER TABLE TA_PEDIDO_EXIGENCIA_PARECER ADD CONSTRAINT "FK_PEDIDO_EXIGENCIA_PARECER1" FOREIGN KEY (ID_PARECER) REFERENCES TA_PEDIDO_DETALHE_PARECER (ID_PARECER);
ALTER TABLE TA_RECEITAS_CONVENIOS ADD CONSTRAINT "FK_RECEITAS_CONVENIOS1" FOREIGN KEY (ID_CONVENIO) REFERENCES TA_CONVENIOS_ARREC (ID_CONVENIO);
ALTER TABLE TA_PEDIDO_AREAS_FAIXA_VALOR ADD CONSTRAINT "FK_PEDIDO_AREAS_FAIXA_VALOR1" FOREIGN KEY (ID_PEDIDO_AREA) REFERENCES TA_PEDIDO_AREAS (ID_PEDIDO_AREA);
ALTER TABLE TA_RTC_REPASSE_DETALHE ADD CONSTRAINT "FK_RTC_REPASSE_DETALHE1" FOREIGN KEY (ID_REPASSE) REFERENCES TA_RTC_REPASSE (ID_REPASSE);
ALTER TABLE TA_CONVENIOS_ARREC ADD CONSTRAINT "FK_CONVENIOS_ARREC1" FOREIGN KEY (ID_BANCO, ID_AGENCIA) REFERENCES TA_BANCO_AGENCIAS (ID_BANCO, ID_AGENCIA);
ALTER TABLE TA_RECEITAS_REPASSE ADD CONSTRAINT "FK_RECEITAS_REPASSE1" FOREIGN KEY (ID_RECEITA) REFERENCES TA_RECEITAS (ID_RECEITA);
ALTER TABLE TA_ARQUIVO_ERRO ADD CONSTRAINT "FK_ARQUIVO_ERRO2" FOREIGN KEY (ID_CODIGO_REJEICAO) REFERENCES TA_TIPO_REJEICAO_ARQUIVOS (ID_CODIGO_REJEICAO);
ALTER TABLE TA_PEDIDO_DOCS_EXIGIDOS ADD CONSTRAINT "FK_PEDIDO_DOCS_EXIGIDOS1" FOREIGN KEY (ID_TIPO_DOCS) REFERENCES TA_PEDIDO_TIPO_DOCS (ID_TIPO_DOCS);
ALTER TABLE TA_RECEITAS_CONVENIOS ADD CONSTRAINT "FK_RECEITAS_CONVENIOS2" FOREIGN KEY (ID_RECEITA) REFERENCES TA_RECEITAS (ID_RECEITA);
ALTER TABLE TA_PEDIDO_AREAS ADD CONSTRAINT "FK_PEDIDO_AREAS2" FOREIGN KEY (ID_TIPO_PEDIDO) REFERENCES TA_PEDIDO_TIPOS (ID_TIPO_PEDIDO);
ALTER TABLE TA_PEDIDO_RESTITUICAO ADD CONSTRAINT "FK_PEDIDO_RESTITUICAO2" FOREIGN KEY (ID_BANCO, ID_AGENCIA) REFERENCES TA_BANCO_AGENCIAS (ID_BANCO, ID_AGENCIA);
ALTER TABLE TA_PEDIDO_DOCS_EXIGIDOS ADD CONSTRAINT "FK_PEDIDO_DOCS_EXIGIDOS2" FOREIGN KEY (ID_TIPO_PEDIDO) REFERENCES TA_PEDIDO_TIPOS (ID_TIPO_PEDIDO);
ALTER TABLE TA_RECEITAS ADD CONSTRAINT "FK_RECEITAS1" FOREIGN KEY (ID_PLANO_CONTAS) REFERENCES TA_PLANO_CONTAS (ID_PLANOCONTAS);
ALTER TABLE TA_PEDIDO_CAMPOS_INFORMADOS ADD CONSTRAINT "FK_PEDIDO_CAMPOS_INFORMADOS2" FOREIGN KEY (ID_PEDIDO_PAGOS) REFERENCES TA_PEDIDO_PAGOS (ID_PEDIDO_PAGOS);
ALTER TABLE TA_PAGOS_AJUSTES_REPASSE ADD CONSTRAINT "FK_PAGOS_AJUSTES_REPASSE1" FOREIGN KEY (TA_RTC_REPASSE) REFERENCES TA_RTC_REPASSE (ID_REPASSE);
ALTER TABLE TA_PAGOS_ARREC ADD CONSTRAINT "FK_PAGOS_ARREC5" FOREIGN KEY (ID_NOSSO_NUMERO_DARE, ID_SEQ_DARE_DETALHE) REFERENCES TA_DARE_DETALHE (ID_NOSSO_NUMERO_DARE, ID_SEQ_DARE_DETALHE);
ALTER TABLE TA_DARE_DETALHE ADD CONSTRAINT "FK_DARE_DETALHE1" FOREIGN KEY (ID_NOSSO_NUMERO_DARE) REFERENCES TA_DARE (ID_NOSSO_NUMERO_DARE);
ALTER TABLE TA_DETALHE_STR ADD CONSTRAINT "FK_DETALHE_STR1" FOREIGN KEY (ID_ARQUIVO_STR) REFERENCES TA_ARQUIVOS_STR (ID_ARQUIVO_STR);
ALTER TABLE TA_ARQUIVO_ERROS_STR ADD CONSTRAINT "FK_ARQUIVO_ERROS_STR1" FOREIGN KEY (ID_ARQUIVO_STR) REFERENCES TA_ARQUIVOS_STR (ID_ARQUIVO_STR);
ALTER TABLE TA_ARQUIVO_ERROS_STR ADD CONSTRAINT "FK_ARQUIVO_ERROS_STR2" FOREIGN KEY (ID_CODIGO_REJEICAO) REFERENCES TA_TIPO_REJEICAO_ARQUIVOS (ID_CODIGO_REJEICAO);
