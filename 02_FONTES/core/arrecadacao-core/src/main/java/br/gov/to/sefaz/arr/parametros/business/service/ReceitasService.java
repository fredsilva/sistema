...
/**
 * Contrato de acesso do serviço de {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas}.
 *
...
public interface ReceitasService extends CrudService<Receitas, Integer> {
    ...
    /**
     * Busca todos as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} com
     * {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas#situacao}
    ...
    /**
     * Serviço para obter as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} por um
    ...
    /**
     * Pesquisar na base de dados as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} que
     * representam o filtro passado.
     *
     * @param filter que contém os campos a serem pesquisados
     * @return todos as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} que se enquandram na
     *      consulta do filtro
     */
