...
/**
 * Contrato de acesso do serviço de {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ConveniosReceitas}.
 *
...
public interface ConveniosReceitasService extends CrudService<ConveniosReceitas, ConveniosReceitasPK> {
    ...
    /**
     * Serviço para remover as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ConveniosReceitas} por um
    ...
    /**
     * Valida se a {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} não está duplicada conforme a
