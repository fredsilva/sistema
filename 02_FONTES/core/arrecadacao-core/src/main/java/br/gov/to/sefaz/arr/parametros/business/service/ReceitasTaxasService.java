...
/**
 * Contrato de acesso do serviço de {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ReceitasTaxas}.
 *
...
public interface ReceitasTaxasService extends CrudService<ReceitasTaxas, ReceitasTaxasPK> {
    ...
    /**
     * Remove todas as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ReceitasTaxas} a partir do
     * {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ReceitasTaxas#idReceita} passado.
     *
    ...
    /**
     * Serviço para obter as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ReceitasTaxas} por um
