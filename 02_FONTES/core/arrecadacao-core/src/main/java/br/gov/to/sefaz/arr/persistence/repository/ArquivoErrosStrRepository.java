...
/**
 * Repositório da entidade {@link br.gov.to.sefaz.arr.persistence.entity.ArquivoErrosStr}.
 *
 * @author <a href="mailto:gabriel.santos@ntconsult.com.br">gabriel.santos</a>
 * @since 28/04/2016 16:48:40
 */
@Repository
public class ArquivoErrosStrRepository extends BaseRepository<ArquivoErrosStr, ArquivoErrosStrPK> {
}
