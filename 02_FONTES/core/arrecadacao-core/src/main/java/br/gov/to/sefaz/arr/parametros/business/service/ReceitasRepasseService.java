...
/**
 * Contrato de acesso do serviço de {@link br.gov.to.sefaz.arr.persistence.entity.ReceitasRepasse}.
 *
...
public interface ReceitasRepasseService extends CrudService<ReceitasRepasse, ReceitasRepassePK> {
    ...
    /**
     * Remove todas as {@link br.gov.to.sefaz.arr.persistence.entity.ReceitasRepasse} a partir do
     * {@link br.gov.to.sefaz.arr.persistence.entity.ReceitasRepasse#idReceita} passado.
     *
    ...
    /**
     * Serviço para obter as {@link br.gov.to.sefaz.arr.persistence.entity.ReceitasRepasse} por um
