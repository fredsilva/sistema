...
public interface ConveniosArrecFacade extends CrudFacade<ConveniosArrec, Long> {
     ...
     * registrados.
     *
     * @return todos os {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Bancos} registrados.
     */
     ...
     * {@link br.gov.to.sefaz.arr.parametros.persistence.entity.BancoAgencias} por um determinado
     * {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Bancos#idBanco}.
     *
     ...
     *
     * @return todos as {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} registradas.
     */
     ...
     * {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ConveniosTarifas} por um
     ...
     * {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} por um
     * determinado {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ConveniosArrec#idConvenio}.
     *
     * @param idConvenio código do convenio para realizar a consulta
     * @return um lista com todas as tarifas que pertencem a um convenio
     ...
     * há uma duplicidade de uma {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ConveniosTarifas} em
    ...
    /**
     * Acessa o {@link br.gov.to.sefaz.arr.parametros.business.service.ConveniosTarifasService} para validar se
     * há uma duplicidade de uma {@link br.gov.to.sefaz.arr.parametros.persistence.entity.Receitas} em
     * {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ConveniosArrec#receitas}.
     *
     ...
     * de dados os {@link br.gov.to.sefaz.arr.parametros.persistence.entity.ConveniosArrec} que satisfazem o filtro
     * passado.
     *
