...
public interface ReceitasFacade extends CrudFacade<Receitas, Integer> {
     ...
     * as {@link br.gov.to.sefaz.arr.persistence.entity.Receitas} que satisfazem o filtro passado.
     *
     * @param filter que contém os campos a serem pesquisados
     * @return todas as {@link br.gov.to.sefaz.arr.persistence.entity.Receitas} que se enquandram na consulta
     *         do filtro.
     */
     ...
     * dados todos os {@link br.gov.to.sefaz.arr.persistence.entity.PlanoContas}.
     *
     * @return todos os {@link br.gov.to.sefaz.arr.persistence.entity.PlanoContas}
     */
     ...
     * {@link br.gov.to.sefaz.arr.persistence.entity.ReceitasTaxas} por um determinado
     * {@link br.gov.to.sefaz.arr.persistence.entity.Receitas#idReceita}.
     *
     ...
     * {@link br.gov.to.sefaz.arr.persistence.entity.ReceitasRepasse} por um determinado
     * {@link br.gov.to.sefaz.arr.persistence.entity.Receitas#idReceita}.
     *
     * @param idReceita código da receita para realizar a consulta
