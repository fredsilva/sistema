...
/**
 * Entidade dos Bancos Arrecadadores.
 *
...
public class Bancos implements SerializableEntity<Integer> {
    ...
    @Min(value = 0, message = "O campo Raíz do CNPJ deve ser igual ou maior do que 0!")
    ...
    public Bancos(int idBanco, String nomeBanco, SituacaoEnum situacao, int cnpjRaiz) {
    ...
    public String toString() {
        return "Bancos{" + "idBanco=" + idBanco + ", nomeBanco='" + nomeBanco + "' cnpjRaiz='" + cnpjRaiz
                + "', situacao=" + situacao + '}';
    }
}
