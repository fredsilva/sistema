...
public class TipoRejeicaoArquivos implements SerializableEntity<Integer> {
    ...
    public TipoRejeicaoArquivos(int idCodigoRejeicao, String motivoRejeicao, int situacao) {
    ...
    public boolean equals(Object obj) {
        ...
        return idCodigoRejeicao == that.idCodigoRejeicao
    ...
    public String toString() {
        return "TipoRejeicaoArquivosEntity{"
